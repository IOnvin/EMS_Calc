...
class QuoteInputModel(models.Model):
    ...
    cloudOpportunityURL = models.URLField(max_length=200, help_text='copy and paste SFDC Opportunity URL', null=True,
                                          blank=True)
    cloudDeskSpecialist = models.CharField(max_length=56, choices=CBD_LEAD_NAMES, null=True)
    ...
    nonStandardTermsOrPenalties = models.CharField(max_length=10, choices=BOOL_VAL, null=True)
    ...
    localCurrency = models.CharField(max_length=56, choices=CURRENCY_TABLE, null=True)
